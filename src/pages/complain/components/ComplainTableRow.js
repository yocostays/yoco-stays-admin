...
export default function ComplainTableRow({ row, selected, onEditRow, onViewRow, onSelectRow, onDeleteRow }) {
  const { ticketid, name, timeToResolve, type, floor, timestamp, status, hostel, assignTo } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell align="left">{timeToResolve}</TableCell>
        <TableCell align="left" sx={{ textTransform: 'capitalize' }}>
          {type}
        </TableCell>
        <TableCell align="left" sx={{ textTransform: 'capitalize' }}>
